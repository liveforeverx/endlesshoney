defmodule EndlesshoneyWeb.Presence do
  @moduledoc """
  ...
  Presences can be tracked in your channel after joining:
      ...
      defmodule Endlesshoney.MyChannel do
        use EndlesshoneyWeb, :channel
        alias Endlesshoney.Presence
  ...
  """
  use Phoenix.Presence, otp_app: :endlesshoney,
                        pubsub_server: Endlesshoney.PubSub
end
